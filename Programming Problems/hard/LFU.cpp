...
void heapify(vector<pair<int, int>> &v, unordered_map<int, int> &m, int i,
             int n) {
...
void increment(vector<pair<int, int>> &v, unordered_map<int, int> &m, int i,
               int n) {
  ++v[i].second;
  heapify(v, m, i, n);
}
...
void insert(vector<pair<int, int>> &v, unordered_map<int, int> &m, int value,
            int &n) {
...
void refer(vector<pair<int, int>> &cache, unordered_map<int, int> &indices,
           int value, int &cache_size) {
